...
exports.openURL = function (n, url, cb) {
    exec(cb, null, 'EbWebview', 'openURL', [n, url]);
}

exports.getStateLoading = function (n, cb) {
    exec(cb, null, 'EbWebview', 'getStateLoading', [n]);
}
...
exports.show = function (n,eventname) {
  exec(null, null, "EbWebview", "show", [n]);
};
...
exports.onMessage = function (cb) {
  exec(cb, null, "EbWebview", "onMessage", []);
};
...
exports.loadUrl = function(n,url) {
  exec(null, null, "EbWebview", "loadUrl", [n, url]);
};
